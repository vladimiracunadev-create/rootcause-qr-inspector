    ...
    final ColorScheme colors =
        ColorScheme.fromSeed(
          ...
          surfaceContainerLow: dark
              ? const Color(0xFF0C1C18)
              : const Color(0xFFEDF3F1),
          surfaceContainer: dark
              ? const Color(0xFF11231E)
              : const Color(0xFFE6EFEC),
          surfaceContainerHigh: dark
              ? const Color(0xFF193029)
              : const Color(0xFFDDE9E6),
          outline: dark ? const Color(0xFF78918A) : const Color(0xFF6F817C),
          outlineVariant: dark
              ? const Color(0xFF354C46)
              : const Color(0xFFC4D3CF),
        );
