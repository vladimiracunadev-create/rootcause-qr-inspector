            ...
            components.append(
                {
                    ...
                    "version": str(value),
                    "scope": scope,
                    "properties": [{"name": "rcqr:resolution", "value": "declared-only"}],
                }
            )
...
def main() -> None:
    ...
    output = {
        ...
        "version": 1,
        "metadata": {
            "component": {"type": "application", "name": "rootcause_qr_inspector", "version": application_version()},
            "properties": [{"name": "rcqr:completeness", "value": completeness}],
        },
