...
| NETWORK | El reconocimiento local no requiere red; URLs se muestran y evalúan antes de abrir | `QrInvestigationEngine`, `ScanSecurityAnalyzer`, pruebas de enlaces |
...
| CODE | CI incluida, análisis/pruebas como gate, dependencias fijadas, SBOM, manifiesto, hashes y feature flags | `.github/workflows`, `tool/`, `SOURCE_MANIFEST.json`, `VALIDATION.md` |
