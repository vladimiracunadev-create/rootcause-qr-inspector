...
void main() {
  test(
    'recovery bundle preserves ciphertext but never includes the key or clear payload',
    () async {
      ...
      final String bundle = await RecoveryService(
        database,
        cipher,
        repository,
      ).exportBundle();
      ...
      expect(bundle, isNot(contains('rcqr_database_key')));
    },
  );
}
